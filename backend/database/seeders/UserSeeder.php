...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $users= [
            ...
            ['id'=>2, 'full_name'=>'KimJame', 'email'=>'KimJame@gmail.com', 'password'=>'123456789!@#$%^&*','role_id'=>3],
            ...
            ['id'=>5, 'full_name'=>'John Jewish', 'email'=>'John@gmail.com', 'password'=>'123456789!@#$%^&*','role_id'=>3],
        ];
